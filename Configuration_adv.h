 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       CUSTOM_X_CURRENT        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Z2)
    #define Z2_CURRENT      CUSTOM_Z2_CURRENT
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      CUSTOM_E_CURRENT
    #define E0_MICROSTEPS    16
